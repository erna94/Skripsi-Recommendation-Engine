...
public class ProductSearchTask extends AsyncTask<WitAIResponse, Void, List<Product>> {
    ...
    private List<Product> getProducts(List<Product> products, WitEntity[] categories, WitEntity[] subcategories, WitEntity intent) {
        String response;// kondisi untuk menerima permintaan user
