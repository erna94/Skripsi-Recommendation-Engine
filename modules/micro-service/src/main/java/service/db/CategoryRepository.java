...
public interface CategoryRepository extends CrudRepository<Category, Long>{
	 ...
	 * @return
	 */
	Category findByIdKategori(Long idKategori);
	
	@Query("SELECT c FROM Category c WHERE c.parentId = :kategoriId")
	...
	List<Category> findChildCategory(@Param(value = "kategoriId") Long kategoriId);
}